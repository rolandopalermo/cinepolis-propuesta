...
\begin{tikzpicture}[font=\sffamily\scriptsize, x=1cm, y=1cm]
  ...
  \node[lt/box, minimum width=4.2cm, fill=white] (amer) at (2.6,11.75) {USA/MX};
  \node[lt/box, minimum width=4.2cm, fill=white] (emea) at (7.6,11.75) {ES};
  \node[lt/box, minimum width=4.2cm, fill=white] (apac) at (12.6,11.75) {JPN};
...
\caption{Arquitectura global de LiveTix}
\end{figure}
...
\begin{itemize}
\item CloudFront y WAF absorben y filtran.
\item La sala de espera dosifica el ingreso al checkout.
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt, anchor=center] at (current page.center) {%
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{checkout-api-admission-flow.png}%
  };
\end{tikzpicture}
\clearpage
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt, anchor=center] at (current page.center) {%
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{checkout-api-admission-flow-054750.png}%
  };
\end{tikzpicture}
\clearpage
